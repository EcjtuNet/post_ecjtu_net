    ...
    <div id="changeNum_content">
        ...
        <div id="changeNum_noshade">
            ...
            <div class="changeNum_password">
                ...
                <script type="text/javascript" src="static/js/change-password.js"></script>
            </div>
            <div class="changeNum_connect">
                <a>联系电话：</a>
                <input class="uername-box" type="text" value="18720071234" />
            </div>
            <div class="changeNum_connect">
                <a>联系邮箱：</a>
                <input class="password-box" type="text" value="1234abcd@qq.com" />
            </div>
            <input id="save-image" type="image" src="static/image_backstage/images_changeNumber/save.png" />
            <!--修改密码-->
                ...
                <div id="changePassword_subject">
                    ...
                    <div id="changePassword_content">
                        ...
                        <div class="check_content">
                            <div class="check_image"><img alt="验证码" src="/image.php" /></div>
                            <a href="static/site/changeNumber.php" class="blue-12Size"> 看不清，换一张</a>
                        </div>
                        <input id="sure-image" type="submit" src="static/image_backstage/images_changeNumber/sure.png" />
                    </div>
